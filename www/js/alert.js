document.addEventListener('DOMContentLoaded', () => {
    function showAlert(alertType, location) {
        const alertContent = {
            cyclone: { topic: 'Cyclone Alert', priority: 'High severity', location: location },
            flood: { topic: 'Flood Alert', priority: 'High severity', location: location },
            drought: { topic: 'Severe Drought', priority: 'High severity', location: location }
        };
    ...
    function removeAlert(alertType) {
        const alertCard = document.querySelector(`.card[data-alert-type="${alertType}"]`);
        if (alertCard) {
            alertCard.remove();
        }
    }
    ...
    const dataSet = [
        ...
        { type: 'flood', location: 'Chennai, India', active: false },
        { type: 'drought', location: 'Bhubaneswar, India', active: false }
    ];
